...
func (*MsgSendIbcPost) Descriptor() ([]byte, []int) {
	return fileDescriptor_3e5324d9ace24007, []int{0}
}
...
func (*MsgSendIbcPostResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3e5324d9ace24007, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgSendIbcPost)(nil), "union.blog.MsgSendIbcPost")
	proto.RegisterType((*MsgSendIbcPostResponse)(nil), "union.blog.MsgSendIbcPostResponse")
}

func init() { proto.RegisterFile("union/blog/tx.proto", fileDescriptor_3e5324d9ace24007) }

var fileDescriptor_3e5324d9ace24007 = []byte{
	// 266 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x2e, 0xcd, 0xcb, 0xcc,
	0xcf, 0xd3, 0x4f, 0xca, 0xc9, 0x4f, 0xd7, 0x2f, 0xa9, 0xd0, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17,
	...
	0xff, 0xff, 0xbd, 0xeb, 0xb6, 0x9b, 0x82, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) SendIbcPost(ctx context.Context, in *MsgSendIbcPost, opts ...grpc.CallOption) (*MsgSendIbcPostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/union.blog.Msg/SendIbcPost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SendIbcPost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/union.blog.Msg/SendIbcPost",
	}
